...
public static class CryptoHelper
{
    ...
    public static string HashArgon2idBase64(string password, ReadOnlySpan<byte> salt, Argon2Parameters? parameters = null)
    {
        var hash = HashArgon2id(Encoding.UTF8.GetBytes(password), salt, parameters);
        return Convert.ToBase64String(hash);
    }
