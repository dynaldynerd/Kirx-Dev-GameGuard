...
public:
  ...
  static int __fastcall CheckEmotionBad(CMonster *pMon, CMonsterAI *pAI, int nDamage);
  static int __fastcall CheckGen(CMonsterAI *pAI, CMonster *pMon);
  static int __fastcall CheckSPF(CMonsterAI *pAI, CMonster *pMon);
  static int __fastcall CheckSPFDelayTime(CMonsterAI *pAI, int nAttackType, unsigned int dwLoopTime);
  static int CheckAlienation(CMonster *pMon);
  static int __fastcall CheckMonArea_N_ChangeState(CMonsterAI *pAI, CMonster *pMon, int bAttackState);
  static void __fastcall SearchPatrollPath(CMonsterAI *pAI, CMonster *pMon);
  static bool __fastcall SearchCharacterPath(CMonsterAI *pAI, CMonster *pMon, CCharacter *pTarget);
  ...
  static int __fastcall UseSkill_Target(CMonster *pMon, CCharacter *pTarget, CMonsterSkill *pSkill);

  static int CheckSPF_MON_MOTIVE_ATTACK_MODE_PASSAGE(
    CMonsterSkill *pSkill,
    int nMotiveValue,
    CMonsterAI *pAI,
    CMonster *pMon,
    CCharacter **ppTar);
  static int CheckSPF_MON_MOTIVE_MY_HP_DOWN(
    CMonsterSkill *pSkill,
    int nMotiveValue,
    CMonsterAI *pAI,
    CMonster *pMon,
    CCharacter **ppTar);
  static int CheckSPF_MON_MOTIVE_OTHER_HP_DOWN(
    CMonsterSkill *pSkill,
    int nMotiveValue,
    CMonsterAI *pAI,
    CMonster *pMon,
    CCharacter **ppTar);
  static int CheckSPF_MON_MOTIVE_DF(
    CMonsterSkill *pSkill,
    int nMotiveValue,
    CMonsterAI *pAI,
    CMonster *pMon,
  ...
  static int(__fastcall *ms_CheckMotiveFunction[4])(
    CMonsterSkill *pSkill,
    int nMotiveValue,
    CMonsterAI *pAI,
    CMonster *pMon,
