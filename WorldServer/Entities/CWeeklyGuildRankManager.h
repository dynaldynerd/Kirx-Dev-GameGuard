...
public:
  ...
  int UpdateTodayTable(char *szDate, _pvppoint_guild_rank_info *pkInfo);
  void OrderRank(_pvppoint_guild_rank_info *pkInfo);
  bool UpdateRankDBRecord(char *szDate, _pvppoint_guild_rank_info *pkInfo);
  bool UpdateOwnerGuild(char *szDate);
  bool SelectOwnerGuild(char *szDate, _weeklyguildrank_owner_info *pkInfo);
  void SetSettlementAreaManageOwnerGuild();
  bool SaveINI();
  void PushSettlementOwnerDBLog(char *pInfo);
  bool UpdateTodayRank(_pvppoint_guild_rank_info *pLoadData);
  ...
  bool IsEmptyRank(_pvppoint_guild_rank_info *pkInfo);
