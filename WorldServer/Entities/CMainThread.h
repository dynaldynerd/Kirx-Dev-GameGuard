...
public:
  ...
  void Load_PostStorage_Complete(_qry_case_post_storage_list_get *pData);
  void Load_ReturnPost_Complete(_qry_case_post_return_list_get *pData);
  void Load_Content_Complete(_qry_case_post_content_get *pData);
  void CompleteUpdateVoteAvailable(_qry_case_update_vote_available *pData);
