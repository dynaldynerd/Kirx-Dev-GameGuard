...
#pragma pack(push, 1)
struct __unaligned __declspec(align(1)) _trunk_download_result_zocl
{
  struct _list
  {
    ...
    __unaligned __declspec(align(1)) unsigned __int64 dwDurPoint;
...
inline _trunk_download_result_zocl::_trunk_download_result_zocl()
{
...
inline unsigned __int16 _trunk_download_result_zocl::size()
{
  if (byRetCode)
  {
    return 1;
