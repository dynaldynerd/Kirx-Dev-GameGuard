...
public:
  ...
  bool RequestAcceptGMCall(CPlayer *pOne, unsigned int dwUserSerial);

  bool SendResponseGMCall(CPlayer *pOne, int bCallState);
  bool SendResponseGMList(CPlayer *pOne, int nCurrPageIndex);
