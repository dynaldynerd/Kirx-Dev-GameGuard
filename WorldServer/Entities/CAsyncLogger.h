...
public:
  ...
  static constexpr ASYNC_LOG_TYPE ALT_NPROTECT_LOG = ::ALT_NPROTECT_LOG;
  static constexpr ASYNC_LOG_TYPE ALT_CHAT_LOG = ::ALT_CHAT_LOG;
  static constexpr ASYNC_LOG_TYPE ALT_POST_LOG = ::ALT_POST_LOG;
