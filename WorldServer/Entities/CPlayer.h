...
public:
  ...
  bool IsLastAttBuff();
  void InitGuildEntryDelay(unsigned __int64 dwGuildEntryDelay);
  void SetGuildEntryDelay(unsigned __int64 dwGuildEntryDelay);
  bool IsGuildEntryDelay();
  void InitPlayerInteg(unsigned __int8 byPlayerInteg);
  void SetPlayerInteg(unsigned __int8 byPlayerInteg);
  void SetTrunkInteg(unsigned __int8 byTrunkInteg);
  bool InvenChangeItemIndex();
  bool EquipChangeItemIndex();
  bool TrunkChangeItemIndex();
  bool TrunkExtChangeItemIndex();
  ...
  __int64 GetClientTimeSerial_combine_ex_item_request_clzo();
  void SetClientTimeSerial_combine_ex_item_request_clzo(__int64 clientTimeSerial);
