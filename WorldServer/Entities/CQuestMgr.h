...
public:
  ...
  bool IsRecvedQuestByNPC(const char *pszNPCCode);
  ...
  bool __CheckCond_LV(unsigned __int8 byCompare, int nLv);
  bool __CheckCond_Grade(unsigned __int8 byCompare, int nGrade);
  bool __CheckCond_Dalant(unsigned __int8 byCompare, unsigned int nDalant);
  bool __CheckCond_Gold(unsigned __int8 byCompare, unsigned int nGold);
  ...
  bool __CheckCond_Have(int nAmount, char *pszItemCode);
  ...
  bool DeleteQuestItem(char *pszItemCode, unsigned __int16 wCount);
  bool ReturnItem(char *pszItemCode, int nEndReturnItemCnt, unsigned __int8 byQuestDBSlot);
  bool CanGiveupQuest(unsigned __int8 byQuestDBSlot);
  bool CheckFailCondition(unsigned __int8 byQuestDBSlot, int nFailCond, char *pszCode);
