...
#define CHAR_CREATE_SUCCESS 0
#define CHAR_CREATE_ALREADY_EXIST_AVATAR 25
#define CHAR_CREATE_INVALID_NAME 47
#define CHAR_DELETE_NOT_RECIVED 0xFF
#define CHAR_DELETE_SUCCESS 0
#define CHAR_DELETE_EMPTY_SLOT 14
